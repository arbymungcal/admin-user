...
<style>
  ...
  .modal-content {
    ...
    border: 2px solid #00bfa5; /* Consistent border color */
  ...
  .modal-header {
    border-bottom: 2px solid #00bfa5; /* Border color matching admin design */
  }

  .modal-footer {
    border-top: 2px solid #00bfa5; /* Border color matching admin design */
  }
